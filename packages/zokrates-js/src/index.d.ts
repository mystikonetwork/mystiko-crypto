declare module '@mystikonetwork/zokrates-js' {
  ...
  export interface ZoKratesProvider {
    ...
    compile(source: string, compileOptions?: CompileOptions): CompilationArtifacts;
    computeWitness(
    ...
    generateProof(program: Uint8Array, witness: Uint8Array, provingKey: Uint8Array, entropy?: string): Proof;
